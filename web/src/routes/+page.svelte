<script>
  ...
  function findSimilarDocuments(result) {
    return results.filter(
      (doc) => doc.id !== result.id && doc.fakeOrNot === result.fakeOrNot
    );
  }
</script>
  ...
  <div class="container">
    ...
    <div class="results-section">
      {#if showResultsInfo}
        <div class="result-info">
          ...
          <div class="pagination" style="display: none;">
            ...
            {/if}
            {#if currentPage < totalPages}
              <button on:click={nextPage} id="next-page" aria-label="Next Page"
                >&gt;&gt;</button
              >
            {/if}
          </div>
        ...
        <div id="popup-modal" class="modal">
          <div class="modal-content">
            ...
            <div id="modal-message" style="text-align: left;">
              <strong></strong>
              {selectedResult.articleText}<br /><br />
              <strong>Fake or Not:</strong>
              {selectedResult.fakeOrNot ? "Fake" : "Not Fake"}<br /><br />
              <strong>Similarity Score:</strong>
              {selectedResult.similarityScore}<br /><br />
      ...
      <SimilarDocumentModal
        ...
        document={selectedSimilarDocument}
